...
function tonav() {
  ...
  document.getElementById("page-name").innerText = document.title.split(" | r1ng_13🥝")[0];
}
...
$.ajax({
  ...
  data: {
    key: 'EBPBZ-QD3KI-G73G4-UPAME-WRT4J-TLFF5',  // 这里要写你的KEY!!!
    output: 'jsonp',
  },
  dataType: 'jsonp',
...
function showWelcome() {
  ...
  let dist = getDistance(113.65, 34.80, ipLoacation.result.location.lng, ipLoacation.result.location.lat); //这里换成自己的经纬度
...
function createtime2() {
  ...
  setTimeout(
    console.warn.bind(
      console,
      "%c ⚡ Powered by r1ng_13🥝 %c 你正在访问r1ng_13🥝の小家",
...
function share_() {
  ...
  try {
    ...
    var subTitle = title.endsWith("| r1ng_13🥝") ? title.substring(0, title.length - 14) : title;
    navigator.clipboard.writeText('r1ng_13🥝的站内分享\n标题：' + subTitle + '\n链接：' + url + '\n欢迎来访！🍭🍭🍭');
    new Vue({
      data: function () {
        this.$notify({
          title: "成功复制分享信息🎉",
...
function createtime() {
  ...
  // 网站诞生时间
  var grt = new Date("03/04/2023 00:00:00");
...
if (localStorage.getItem("blogbg") != undefined) {
  ...
  document.getElementById("defineBg").innerText = `:root{
    --default-bg: url(https://cdn.staticaly.com/gh/r1ng13/screenshot@main/img/dm14.webp);
    --darkmode-bg:url(https://cdn.staticaly.com/gh/r1ng13/screenshot@main/img/yuanshen1.webp);
...
<details class="folding-tag" cyan><summary> 查看二次元背景 </summary>
              <div class='content'>
              <div class="bgbox"><a href="javascript:;" rel="noopener external nofollow" style="background-image:url(https://gitee.com/ctf101/blog-images/raw/master/img/202401121435556.webp)" class="imgbox" onclick="changeBg('url(https://gitee.com/ctf101/blog-images/raw/master/img/202401121435556.webp)')"></a><a href="javascript:;" rel="noopener external nofollow" style="background-image:url(https://gitee.com/ctf101/blog-images/raw/master/img/202401121434238.png)" class="imgbox" onclick="changeBg('url(https://gitee.com/ctf101/blog-images/raw/master/img/202401121434238.png)')"></a><a href="javascript:;" rel="noopener external nofollow" style="background-image:url(https://gitee.com/ctf101/blog-images/raw/master/img/202401121454604.png)" class="imgbox" onclick="changeBg('url(https://gitee.com/ctf101/blog-images/raw/master/img/202401121454604.png)')"></a><a href="javascript:;" rel="noopener external nofollow" style="background-image:url(https://gitee.com/ctf101/blog-images/raw/master/img/202401121433978.jpg)" class="imgbox" onclick="changeBg('url(https://gitee.com/ctf101/blog-images/raw/master/img/202401121433978.jpg)')"></a><a href="javascript:;" rel="noopener external nofollow" style="background-image:url(https://gitee.com/ctf101/blog-images/raw/master/img/202401121431329.jpg)" class="imgbox" onclick="changeBg('url(https://gitee.com/ctf101/blog-images/raw/master/img/202401121431329.jpg)')"></a><a href="javascript:;" rel="noopener external nofollow" style="background-image:url(https://gitee.com/ctf101/blog-images/raw/master/img/202401121430443.jpg)" class="imgbox" onclick="changeBg('url(https://gitee.com/ctf101/blog-images/raw/master/img/202401121430443.jpg)')"></a><a href="javascript:;" rel="noopener external nofollow" style="background-image:url(https://gitee.com/ctf101/blog-images/raw/master/img/202401121432563.png)" class="imgbox" onclick="changeBg('url(https://gitee.com/ctf101/blog-images/raw/master/img/202401121432563.png)')"></a><a href="javascript:;" rel="noopener external nofollow" style="background-image:url(https://gitee.com/ctf101/blog-images/raw/master/img/202401121457028.jpg)" class="imgbox" onclick="changeBg('url(https://gitee.com/ctf101/blog-images/raw/master/img/202401121457028.jpg)')"></a></div>
              </div>
            </details>
...
<details class="folding-tag" cyan><summary> 查看风景背景 </summary>
              <div class='content'>
              <div class="bgbox"><a href="javascript:;" rel="noopener external nofollow" style="background-image:url(https://cdn.staticaly.com/gh/r1ng13/screenshot@main/img/firewatch-forest-landscape-in-game-minimalistic-games-7558.jpg)" class="imgbox" onclick="changeBg('url(https://cdn.staticaly.com/gh/r1ng13/screenshot@main/img/firewatch-forest-landscape-in-game-minimalistic-games-7558.jpg)')"></a></div>
              </div>
            </details>
